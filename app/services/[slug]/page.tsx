      ...
      <div className='relative m-auto max-w-[950px]'>
          ...
          <ol role='list' className='flex space-x-2'>
            <li>
              <div className='flex items-center'>
                <Link href='/services' className='mr-2 text-sm font-medium text-gray-900 dark:text-white'>
                  Services
                </Link>
        ...
        <div className='grid md:grid-cols-2 md:gap-x-8'>
          ...
          <div>
            ...
            <div dangerouslySetInnerHTML={{ __html: product.metadata.description }} className='mb-6 text-sm text-gray-700 dark:text-white' />
          </div>
        </div>
      </div>
    </section>
