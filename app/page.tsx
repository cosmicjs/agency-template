    ...
    <main>
      ...
      <section className='grid items-center py-10 bg-zinc-50 dark:bg-zinc-900'>
        <div className='relative m-auto max-w-6xl flex flex-col items-start gap-2'>
          <h2 className='m-auto max-w-[800px] text-center text-3xl md:text-6xl font-display text-zinc-900 dark:text-zinc-100 pt-8'>{page.metadata.section_title}</h2>
          <p dangerouslySetInnerHTML={{ __html: page.metadata.content }} className='m-auto mb-16 max-w-[800px] text-center text-zinc-700 dark:text-zinc-300' />
