  ...
  return (
    <>
      <div className='mb-10 w-full max-h-[500px] overflow-hidden'>
        <img src={`${blog.metadata.image.imgix_url}?w=2000&auto=format,compression`} alt={blog.title} className='object-cover w-full' />
      </div>
      <section className='container grid items-center pb-8 m-auto'>
        <div className='relative m-auto flex max-w-[750px] flex-col items-start gap-2'>
          <h1 className='mb-4 text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl text-black dark:text-white'>{blog.title}</h1>
