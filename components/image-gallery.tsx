...
export function ImageGallery({ items }: { items: GalleryItemType[] }) {
  ...
  return (
    <>
      <div>
        <img src={`${mainItem.image.imgix_url}?w=1200&auto=format,compression`} alt={mainItem.description} className='rounded-xl mb-4 h-80 w-full object-cover object-center' />
      </div>
