      ...
      >
        ...
        >
          <div className='relative z-10'>
            ...
            <p className='line-clamp-3 w-full pt-3 text-gray-600 dark:text-gray-400'>{post.metadata.content.slice(0, 200)}...</p>
          </div>
          <div
          ...
          >
            <div className='flex w-full items-center gap-10 text-sm text-gray-700 dark:text-gray-300'>
              <div className='flex items-center gap-3'>
                ...
                >
                  <img alt={post.metadata.author.title} src={`${post.metadata.author.metadata.image.imgix_url}?w=400&auto=format,compression`} className='w-[50px] h-[50px] rounded-full object-cover' />
                </div>
                <div>
                  <div>
                    <span className='font-semibold'>{post.metadata.author.title}</span>
                    <br />
