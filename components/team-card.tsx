  ...
  return (
    <div className='flex w-full flex-col overflow-hidden rounded-lg bg-white  dark:bg-zinc-800 md:flex-row border border-zinc-200 dark:border-zinc-700'>
      ...
      <div className='w-full space-y-2 p-6 text-left md:w-3/5 md:p-4'>
        <p className='text-xl font-bold text-zinc-700 dark:text-zinc-100'>{member.title}</p>
        <p className='text-base font-normal text-zinc-700 dark:text-zinc-100'>{member.metadata.position}</p>
        <p className='text-base font-normal leading-relaxed text-zinc-700 dark:text-gray-300'>{member.metadata.bio}</p>
